...
void BumperToPC::coreSensorCB(const kobuki_msgs::msg::SensorState::ConstSharedPtr msg)
{
  ...
  if ((msg->bumper & kobuki_msgs::msg::SensorState::BUMPER_LEFT) ||
      (msg->cliff  & kobuki_msgs::msg::SensorState::CLIFF_LEFT))
  {
  ...
  if ((msg->bumper & kobuki_msgs::msg::SensorState::BUMPER_CENTRE) ||
      (msg->cliff  & kobuki_msgs::msg::SensorState::CLIFF_CENTRE))
  {
  ...
  if ((msg->bumper & kobuki_msgs::msg::SensorState::BUMPER_RIGHT) ||
      (msg->cliff  & kobuki_msgs::msg::SensorState::CLIFF_RIGHT))
  {
...
void BumperToPC::init()
{
  ...
  core_sensor_sub_ = nh.subscribe("core_sensors", 10, &BumperToPC::coreSensorCB, this);
